...
| `docs/spec/OXREPLAY_OXXLPLAY_OBSERVATION_SEAM.md` | Section 10: restructured into 5 subsections — consumer rule, labeling rule, comparison reliability badge, interpretation caution, platform rule. |
...
6. `docs/spec/OXREPLAY_OXXLPLAY_OBSERVATION_SEAM.md` — OxXlPlay seam, Section 10 for OneCalc comparison use
...
3. **OxXlPlay**: The observation seam still lacks a formal adapter capability manifest and richer registry-pinned diff structure. This is `OxXlPlay` upstream documentation debt.
