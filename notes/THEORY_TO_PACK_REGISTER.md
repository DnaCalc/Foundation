...
| TH-006 | Runtime overlays should report incremental-vs-fallback economics | Empirical + conformance pack | PACK.overlay.fallback_economics | deferred | Metrics/threshold contract pending |
