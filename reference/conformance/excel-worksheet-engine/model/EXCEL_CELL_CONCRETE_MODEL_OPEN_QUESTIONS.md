...
|---|---|---|---|---|---|---|---|
| ECM-Q-001 | Formula grammar edge cases (`@`, `#`, intersection spacing, nested structured refs, scoped-name qualification, external-ref open-state policy) | ECM-FML-001;ECM-FML-002;ECM-FML-003 | XLS-CF-FL-001;XLS-CF-FL-002;XLS-CF-FL-003;XLS-CF-FL-004;XLS-CF-FL-006;XLS-CF-FL-009 | empirical-gap | ECS-003;ECS-004;ECS-005;ECS-008;ECS-012;ECS-EB-033;ECS-EB-035;ECS-EB-036;ECS-EB-037;ECS-EB-038;ECS-EB-040;EMP-0011 | Cross-build/channel replay of pass-2 grammar corpus including scoped-name and external-ref open-state permutations under documented provisional policy wording | Grammar and precedence table is stable across targeted builds/channels, scoped-name policy remains convergent, and external-ref open-state policy is bounded |
...
| ECM-Q-013 | Number-format underspec closure (`formatCode`, `numFmtId`) | ECM-FMT-001 | XLS-CF-FM-001;XLS-CF-FM-007 | spec-gap | REFX-004;REFX-005;REFX-006 | Policy-document pass plus targeted empirical render/default-id probes across locales/builds | Underspec lanes are replaced by explicit versioned policy rows and tests |
| ECM-Q-014 | Style hierarchy precedence closure (row/column/cell/table/CF) | ECM-FMT-005 | XLS-CF-FM-009;XLS-CF-FM-010 | empirical-gap | REFX-006;REFX-010;ECS-030 | Precedence collision matrix + workbook XML extraction for style indices/dxf overlays | Stable precedence table with explicit conflict resolution rules and caveat tags |
| ECM-Q-015 | Defaults provenance (font/size/base style/sheet defaults) | ECM-FMT-006 | XLS-CF-FM-011 | empirical-gap | REFX-004;REFX-005;REFX-010 | Fresh-workbook/template/profile capture matrix and style-table diff evidence | Defaults are represented as profile-bound policy, not hardcoded assumptions |
| ECM-Q-016 | Formula-visible formatting and CF observability boundary | ECM-FMT-007;ECM-FMT-008 | XLS-CF-FM-013;XLS-CF-FM-014 | empirical-gap | ECS-110;ECS-062;ECS-063;REFX-010 | Dedicated probes for TEXT/CELL/INFO and legacy GET.CELL compatibility lane against CF-triggered style changes | Explicit boundary table: ambient formatting visibility, CF-effective-style visibility, and compatibility caveats |
...
| ECM-Q-012 | Function-call admission vs runtime error boundaries (`SIN` canonical lane) | ECM-FML-004;ECM-FUN-001;ECM-COE-001 | XLS-CF-FL-012;XLS-CF-FN-001;XLS-CF-TV-007 | spec-gap | ECS-008;ECS-109;ECS-113;ECS-114;ECS-115 | Dedicated empirical matrix for required-arg omission (`SIN()`), scalar coercion errors (`SIN("asd")`), array-lift mixed-type behavior (`SIN({1,"asd",3})`), and numeric-domain mapping (`ASIN(2)`) across builds/channels | Parse-admission vs runtime-error policy becomes explicit, stable, and version-scoped where needed |
